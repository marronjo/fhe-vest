...
contract FHEVestingWallet is Permissioned {
    ...
    function createNewVestingSchedule(
        address beneficiary,
        address token,
        ...
        returns (euint32)
    {
        ...
        return FHE.select(
            FHE.lt(currentTimestamp, startTimestamp),
            FHE.asEuint32(0),
            _calculateVestingAmount(totalAllocation, startTimestamp, currentTimestamp, durationSeconds)
        );
    }
        ...
        returns (euint32)
    {
        ...
        return FHE.select(
            FHE.gte(currentTimestamp, FHE.add(startTimestamp, durationSeconds)),
            totalAllocation,
            _calculateVestingMidAuction(totalAllocation, currentTimestamp, startTimestamp, durationSeconds)
        );
    }
    ...
    function _calculateVestingMidAuction(
        euint32 totalAllocation,
        euint32 currentTimestamp,
        euint32 startTimestamp,
        euint32 durationSeconds
